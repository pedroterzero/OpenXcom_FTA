...
private:
	...
	int _offset;
	int _playingState;
	bool _hasAudio, _useInternalAudio, _customCutscene;
	int _videoDelay;
	double _volume;
...
public:
	...
	bool init(const char *filename, void(*frameCallBack)(), bool customCutscene, Game *game, bool useAudio, int dx, int dy);
