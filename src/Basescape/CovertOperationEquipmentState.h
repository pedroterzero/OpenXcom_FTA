...
*/
class CovertOperationEquipmentState : public State
{
private:
	TextButton* _btnOk, * _btnInventory;
	TextEdit* _btnQuickSearch;
	Window* _window;
	Text* _txtTitle, * _txtItem, * _txtStores, * _txtAvailable, * _txtChances, * _txtCrew;
...
public:
	...
	CovertOperationEquipmentState(Base* base, CovertOperationStartState* operation);
